...
import { SkladnikiComponent } from 'app/entities/skladniki/skladniki.component';
...
describe('Component Tests', () => {
  describe('Skladniki Management Component', () => {
    let comp: SkladnikiComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SkladnikiComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.skladnikis[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
