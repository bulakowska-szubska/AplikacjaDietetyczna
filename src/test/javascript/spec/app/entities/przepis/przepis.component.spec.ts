...
import { PrzepisComponent } from 'app/entities/przepis/przepis.component';
import { PrzepisService } from 'app/entities/przepis/przepis.service';
import { Przepis } from 'app/shared/model/przepis.model';

describe('Component Tests', () => {
  describe('Przepis Management Component', () => {
    let comp: PrzepisComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PrzepisComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.przepis[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
